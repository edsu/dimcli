    ...
    "sources": {
        "clinical_trials": {
            "fields": {
                ...
                "end_date": {
                    "description": "End of date of the clinical trial.",
                    "is_entity": False,
                    "is_facet": False,
                    "is_filter": True,
                    "is_multivalue": False,
                ...
                "start_date": {
                    "description": "Start of date of the clinical trial.",
                    "is_entity": False,
                    "is_facet": False,
                    "is_filter": True,
                    "is_multivalue": False,
                ...
                "study_designs": {
                    "description": "The study design methods",
                    "is_entity": False,
                    "is_facet": True,
                    "is_filter": True,
                    "is_multivalue": True,
        ...
        "grants": {
            "fields": {
                ...
                "funder_org_states": {
                    "description": "State name for funding organisation.",
                    "is_entity": True,
                    "is_facet": True,
                    "is_filter": True,
                    "is_multivalue": True,
                ...
                "funding_schemes": {
                    "description": "Information that the data sources provide regarding grouping of grants according to funding schemes, programs, mechanisms etc. NOTE: funding scheme labels are not normalised and hence cannot be safely used for aggregrations.",
                    "is_entity": False,
                    "is_facet": False,
                    "is_filter": True,
                    "is_multivalue": True,
        ...
        "organizations": {
            "fields": {
                ...
                "country_code": {
                    "description": "Country of the organisation, identified using GeoNames codes",
                    "is_entity": False,
                    "is_facet": True,
                    "is_filter": True,
                    "is_multivalue": False,
                ...
                "types": {
                    "description": "Type of an organization. Available types include: ``Company``, ``Education``, ``Healthcare``, ``Nonprofit``, ``Facility``, ``Other``, ``Government``, ``Archive``.",
                    "is_entity": False,
                    "is_facet": True,
                    "is_filter": True,
                    "is_multivalue": True,
        ...
        "patents": {
            "fields": {
                ...
                "federal_support": {
                    "description": "The government interest statement describes how an invention was funded by a federal research grant or procurement contract.",
                    "is_entity": False,
                    "is_facet": False,
                    "is_filter": True,
                    "is_multivalue": True,
        ...
        "publications": {
            "fields": {
                ...
                "editors": {
                    "description": "For supported publication types, the associated editors.",
                    "is_entity": False,
                    "is_facet": False,
                    "is_filter": True,
                    "is_multivalue": False,
